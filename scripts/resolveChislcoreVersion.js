/**
 * Resolve the chislcore version tag to download for packaging.
 *
 * Order:
 ...
 * scripts/prepareChislcore.js and scripts/pack-web-cli.js before
...
function resolveChislcoreVersion(projectRoot) {
  ...
  try {
    ...
    if (pkg && typeof pkg.chislcoreVersion === 'string' && pkg.chislcoreVersion.trim()) {
      return pkg.chislcoreVersion.trim();
    }
  } catch {
    // fall through
  }
...
module.exports = { resolveChislcoreVersion };
