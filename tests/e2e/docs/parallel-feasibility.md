...
- Dev mode: `~/Library/Application Support/ChislUi-Dev/` (macOS)
...
2. Modify `getDevAppName()` to return worker-specific name:
   ...
   return `ChislUi-E2E-Worker-${workerId}`;
   ```
3. Each worker gets isolated:
   - `~/Library/Application Support/ChislUi-E2E-Worker-0/config/chislui.db`
   - `~/Library/Application Support/ChislUi-E2E-Worker-1/config/chislui.db`
