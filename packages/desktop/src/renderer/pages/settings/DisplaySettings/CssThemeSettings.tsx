      ...
      >
        {themes.map((theme) => {
          ...
          return (
            <div
              key={theme.id}
              className={`relative cursor-pointer rounded-card overflow-hidden border-2 transition-all duration-200 h-112px w-full ${activeThemeId === theme.id ? 'border-[var(--brand)]' : 'border-transparent hover:border-border-2'}`}
              style={cardStyle}
