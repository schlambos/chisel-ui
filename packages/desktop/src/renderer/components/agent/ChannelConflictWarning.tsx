/**
 * @license
 * Copyright 2025 Chisel (aionui.com)
...
/**
 * Warning component when OpenClaw channel conflicts with Chisel Channels
 */
    ...
    <Alert
      ...
      content={
        <Space direction='vertical' size='medium' style={{ width: '100%' }}>
          <Paragraph>
            <Text bold>OpenClaw is handling {platformName} messages, not Chisel.</Text>
          </Paragraph>
          ...
          <Paragraph>
            ...
            <ul>
              <li>
                <Text type='error'>✗ Switching agents in Chisel will have no effect</Text>
              </li>
              <li>
          ...
          <Paragraph>
            <Text bold>To use Chisel Channels and switch agents:</Text>
          </Paragraph>
          ...
          <Paragraph>
            ...
            <br />
            Then restart OpenClaw and Chisel.
          </Paragraph>

          <Paragraph>
            <Text type='secondary'>Option 2: Use a different bot</Text>
            <br />
            Create a new {platformName} bot with different credentials for Chisel.
          </Paragraph>

          <Paragraph>
            <Text type='secondary'>Option 3: Keep using OpenClaw</Text>
            <br />
            Disable {platformName} in Chisel Channels and continue using OpenClaw's integration.
          </Paragraph>
