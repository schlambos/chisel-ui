...
export type I18nKey =
  ...
  | 'library.bucket.month'
  | 'library.bucket.older'
  | 'library.bucket.today'
  | 'library.bucket.week'
  | 'library.bucket.yesterday'
  | 'library.drawer.agent'
  | 'library.drawer.alsoInConversation'
  | 'library.drawer.close'
  | 'library.drawer.createdAt'
  | 'library.drawer.fromConversation'
  | 'library.drawer.generatedFrom'
  | 'library.drawer.prompt'
  | 'library.drawer.showInExplorer'
  | 'library.drawer.showInFileManager'
  | 'library.drawer.showInFinder'
  | 'library.drawer.updatedAt'
  | 'library.drawer.viewInConversation'
  | 'library.empty'
  | 'library.fileCount'
  | 'library.fileCount_other'
  ...
  | 'library.tabs.sheet'
  | 'library.tabs.slide'
  | 'library.time.daysAgo'
  | 'library.time.daysAgo_other'
  | 'library.time.hoursAgo'
  | 'library.time.hoursAgo_other'
  | 'library.time.minutesAgo'
  | 'library.time.minutesAgo_other'
  | 'library.time.monthsAgo'
  | 'library.time.monthsAgo_other'
  | 'library.time.weeksAgo'
  | 'library.time.weeksAgo_other'
  | 'library.title'
  | 'library.toast.mockJump'
  | 'library.toast.mockMenu'
  | 'library.toast.mockOpen'
  | 'library.tooltip.from'
  | 'library.totalAssets'
  | 'library.totalAssets_other'
  | 'library.totalFiles'
  | 'library.totalFiles_other'
  | 'library.view.conversation'
  | 'library.view.file'
  | 'library.view.list'
  | 'login.brand'
  | 'login.errors.empty'
